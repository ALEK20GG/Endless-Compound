...
$login = function () {
    ...
    $this->redirectIntended(default: route('game.index', absolute: false), navigate: true);
};

?>

<div>
    {{-- Messaggio di stato sessione (es. dopo reset password) --}}
    ...
    <form wire:submit="login">
        ...
        {{-- Pulsante login + link password dimenticata --}}
    ...
    <div class="mt-4 text-center text-sm text-gray-600 dark:text-gray-400">
        ...
        <a
            href="{{ route('register') }}"
            wire:navigate
            class="underline text-gray-800 dark:text-gray-200 hover:text-gray-900 dark:hover:text-gray-100"
        >
            {{ __('Registrati') }}
        </a>
    </div>
